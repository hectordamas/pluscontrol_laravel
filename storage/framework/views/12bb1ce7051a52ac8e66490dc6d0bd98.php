        ...
        <div class="col-md-7">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('users/update')); ?>" method="post" class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pluscontrol.grupo-plus.com/resources/views/users/edit.blade.php ENDPATH**/ ?>