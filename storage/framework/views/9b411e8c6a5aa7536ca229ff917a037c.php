...
<body>
  <div class="content-wrapper">
    ...
    <section class="wrapper bg-soft-primary" id="planes">
      <div class="container pb-19 pt-md-14 pb-md-21 text-center">
        <div class="row">
        ...
        <div class="pricing-wrapper position-relative mt-n18 mt-md-n21 mb-12 mb-md-15">
          ...
          <div class="row gy-6 mt-3 mt-md-5 justify-content-center">
            ...
            <div class="col-md-6 col-12">
              <img src="<?php echo e(asset('plans/basic.png')); ?>" style="width: 100%;" alt="Plan Basic">
            </div>

            <div class="col-md-6 col-12">
              <img src="<?php echo e(asset('plans/basic_plus.png')); ?>" style="width: 100%;" alt="Plan Basic Plus">
            </div>

            <div class="col-md-6 col-12">
              <img src="<?php echo e(asset('plans/master.png')); ?>" style="width: 100%;" alt="Plan Master">
            </div>

            <div class="col-md-6 col-12">
              <img src="<?php echo e(asset('plans/master_plus.png')); ?>" style="width: 100%;" alt="Plan Master Plus">
            </div>
...
</html><?php /**PATH D:\Proyectos en Curso\pluscontrol\pluscontrol_laravel\resources\views/welcome.blade.php ENDPATH**/ ?>