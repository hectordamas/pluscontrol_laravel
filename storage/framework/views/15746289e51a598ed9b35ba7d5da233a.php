    ...
    <div class="container py-14 py-md-16">
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
          ...
          <form class="contact-form" method="post" action="<?php echo e(url('enviarSolicitud')); ?>">
            <?php echo csrf_field(); ?>
            <div class="row gx-4">
              <div class="col-md-6">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos en Curso\pluscontrol\pluscontrol_laravel\resources\views/publico/formularioDeSolicitud.blade.php ENDPATH**/ ?>