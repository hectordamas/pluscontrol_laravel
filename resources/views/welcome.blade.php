        ...
        <div class="pricing-wrapper position-relative mt-n18 mt-md-n21 mb-12 mb-md-15">
          ...
          <div class="row gy-6 mt-3 mt-md-5 justify-content-center">
            ...
            <div class="col-md-6 col-12">
              <img src="{{ asset('plans/basic.png') }}" style="width: 100%;" alt="Plan Basic">
            </div>

            <div class="col-md-6 col-12">
              <img src="{{ asset('plans/basic_plus.png') }}" style="width: 100%;" alt="Plan Basic Plus">
            </div>

            <div class="col-md-6 col-12">
              <img src="{{ asset('plans/master.png') }}" style="width: 100%;" alt="Plan Master">
            </div>

            <div class="col-md-6 col-12">
              <img src="{{ asset('plans/master_plus.png') }}" style="width: 100%;" alt="Plan Master Plus">
            </div>
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-4">
          <div class="widget">
            ...
            <p class="mb-4">© {{ date('Y') }} Producciones Plus C.A. <br class="d-none d-lg-block" />Todos los derechos reservados.</p>
